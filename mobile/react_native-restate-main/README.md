# Мобильное приложение недвижимости

Современное мобильное приложение для поиска недвижимости на React Native с локальными данными и простой авторизацией.

## 🔋 Функциональность

👉 **Простая авторизация**: Быстрый вход в приложение одним нажатием

👉 **Главная страница**: Отображение последних и рекомендованных объектов недвижимости с функциями поиска и фильтрации

👉 **Страница поиска**: Просмотр всех типов недвижимости с удобным интерфейсом

👉 **Страница деталей объекта**: Подробная информация об отдельных объектах недвижимости, включая изображения и ключевые характеристики

👉 **Страница профиля**: Настройки пользователя и управление профилем

👉 **Локальные данные**: Работа с данными без необходимости внешних сервисов
...
В результате вы увидите опции для открытия приложения в:
...
Вы можете начать разработку, редактируя файлы в директории **app**. Проект использует [file-based routing](https://docs.expo.dev/router/introduction).

## 📱 Особенности

- **Русифицированный интерфейс**: Все тексты переведены на русский язык
- **Локальные данные**: Приложение работает с предустановленными данными о недвижимости
- **Упрощенная авторизация**: Простой вход без необходимости регистрации
- **Современный дизайн**: Использование Tailwind CSS для стилизации
- **Отзывчивый интерфейс**: Адаптирован для различных размеров экранов
